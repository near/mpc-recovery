...
impl MpcContract {
    fn add_request(&mut self, payload: &SignatureRequest, signature: &Option<SignatureResponse>) {
    ...
    fn add_signature(&mut self, payload: &SignatureRequest, signature: SignatureResponse) {
