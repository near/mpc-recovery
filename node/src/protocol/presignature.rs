...
pub struct PresignatureManager {
    ...
    presignatures: BTreeMap<PresignatureId, Presignature>,
    /// Ongoing triple generation protocols
    generators: BTreeMap<PresignatureId, PresignatureGenerator>,
...
impl PresignatureManager {
    ...
    pub fn generate(&mut self, triple0: Triple, triple1: Triple) {
        let id = rand::random();
